...
<body>
	<div class="container" style="margin-top: 20px">
		<form:form class="form-horizontal" action="boardupdate.do" commandName="boardupdate" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input type="text" class="form-control" path="writer" readonly="true"/>
				</div>
			</div>
			<div class="form-group">
