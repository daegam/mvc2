...
<body>
	...
	<div class="container">
		...
		<form:form class="form-horizontal" commandName="member">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input path="road_addr" class="form-control" id="road_addr" readonly="true"/>
					<form:input path="jibun_addr" class="form-control" id="jibun_addr" readonly="true"/>
	...
	<script>
		...
		/* $(function() {
			...
			$('#btn_join').bind('click', function(){
				...
				if($('#detail_addr').val().trim() == "" || $('#postcode').val() == "" || $('#road_addr').val() == "" || $('jibun_addr').val() == ""){
					flag = false;
				}else{
					flag = true;
				}
